...
# from datasets.nuplan_val import NuPlanVal
...
from datasets.create_dataset import create_val_datasets
...
def main(args):
    ...
    test_data = create_val_datasets(args)
